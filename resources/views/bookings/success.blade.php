...
<div class="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        ...
        <h1 class="text-3xl font-bold text-gray-900 mb-4 text-center">Pesanan Sewa Alat Diterima!</h1>

        <div class="bg-blue-50 border-l-4 border-blue-500 rounded-lg p-6 mb-6 shadow-sm">
            <p class="text-gray-700 text-center">
                <span class="font-semibold text-gray-900">Permintaan sewa alat Anda dengan kode</span>
                <span class="font-bold text-blue-600">{{ $booking->order_number }}</span>
            ...
            <p class="text-gray-700 text-center mt-3">
                Silakan simpan halaman ini sebagai bukti permohonan Anda.
            </p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-md p-6 mb-6 border border-gray-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                <div class="border-l-4 border-yellow-500 pl-4">
                    <p class="text-sm text-gray-600 font-semibold">Kode Pesanan</p>
                    <p class="text-lg text-gray-900 font-semibold">{{ $booking->order_number }}</p>
                </div>
                <div class="border-l-4 border-blue-500 pl-4">
                    <p class="text-sm text-gray-600 font-semibold">Nama Penyewa</p>
                    <p class="text-lg text-gray-900 font-semibold">{{ $booking->renter_name }}</p>
                </div>
                <div class="border-l-4 border-indigo-500 pl-4">
                    <p class="text-sm text-gray-600 font-semibold">NPM / NIK</p>
                    <p class="text-lg text-gray-900 font-semibold">{{ $booking->renter_npm_nik }}</p>
                </div>
                <div class="border-l-4 border-emerald-500 pl-4">
                    <p class="text-sm text-gray-600 font-semibold">Email</p>
                    <p class="text-lg text-gray-900 font-semibold">{{ $booking->renter_email }}</p>
                </div>
                <div class="border-l-4 border-teal-500 pl-4">
                    <p class="text-sm text-gray-600 font-semibold">No. Telepon</p>
                    <p class="text-lg text-gray-900 font-semibold">{{ $booking->renter_phone }}</p>
                </div>
                <div class="border-l-4 border-green-500 pl-4">
                    <p class="text-sm text-gray-600 font-semibold">Tanggal Sewa</p>
                    <p class="text-lg text-gray-900 font-semibold">{{ $booking->start_date->format('d M Y') }} - {{ $booking->end_date->format('d M Y') }}</p>
                </div>
                <div class="border-l-4 border-purple-500 pl-4">
                    <p class="text-sm text-gray-600 font-semibold">Durasi</p>
                    <p class="text-lg text-gray-900 font-semibold">{{ $booking->duration_days }} Hari</p>
                </div>
                <div class="border-l-4 border-orange-500 pl-4">
                    <p class="text-sm text-gray-600 font-semibold">Lokasi Sewa</p>
                    <p class="text-lg text-gray-900 font-semibold">{{ $booking->rental_location }}</p>
                </div>
                <div class="border-l-4 border-yellow-500 pl-4">
                    <p class="text-sm text-gray-600 font-semibold">Total Harga</p>
                    <p class="text-lg text-gray-900 font-semibold">Rp {{ number_format($booking->total_price, 0, ',', '.') }}</p>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-md p-6 mb-6 border border-gray-100">
            <h2 class="text-xl font-semibold text-gray-900 mb-4 text-center">Rincian Peralatan</h2>
            <div class="space-y-4">
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="text-left w-full">
                    ...
                    <p class="text-sm text-gray-700 mb-3">
                        Silakan lakukan <span class="font-semibold">screenshot halaman ini</span> sebagai bukti permohonan sewa alat Anda telah diterima.
                    </p>
        ...
        <div class="bg-white rounded-2xl shadow-md p-6 mb-6 border border-gray-100">
            <h3 class="text-lg font-semibold text-gray-900 mb-4 text-center">Hubungi Pengurus</h3>
            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', config('contact.cp_band', '6281234567890')) }}" target="_blank" class="flex items-center gap-4 p-4 border-2 border-green-500 rounded-lg hover:bg-green-50 transition-all">
                ...
                <div class="flex-1">
                    <p class="text-xs text-gray-600">WhatsApp Pengurus</p>
        ...
        <div class="flex flex-col gap-3">
            ...
            <a href="{{ route('equipment.index') }}" class="btn btn-outline btn-warning">
                Lihat Peralatan Lain
            </a>
        </div>
    </div>
</div>
