...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 28px; border-bottom: 3px solid #f59e0b; padding-bottom: 18px; }
        .header-left h1 { font-size: 28px; color: #1f2937; margin-bottom: 4px; }
        .header-left p, .header-right p { font-size: 13px; color: #6b7280; }
        .header-logo { width: 72px; height: 72px; object-fit: contain; }
        .invoice-no { font-size: 18px; font-weight: bold; color: #f59e0b; }
        .section { margin-bottom: 22px; }
        .section-title { background: #fff7ed; border-left: 4px solid #f59e0b; padding: 10px 14px; margin-bottom: 12px; font-size: 13px; font-weight: bold; color: #b45309; text-transform: uppercase; letter-spacing: .5px; }
        .grid-2 { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; }
        .info-item { margin-bottom: 10px; }
        .info-label { font-size: 11px; color: #9ca3af; text-transform: uppercase; letter-spacing: .5px; margin-bottom: 2px; }
        .info-value { font-size: 14px; font-weight: 600; color: #111827; }
        .summary { margin-top: 10px; background: #f9fafb; border-left: 4px solid #f59e0b; padding: 16px; }
        .summary-row { display: flex; justify-content: space-between; margin-bottom: 8px; font-size: 13px; }
        .summary-row.total { border-top: 2px solid #e5e7eb; padding-top: 10px; margin-top: 10px; font-weight: bold; font-size: 15px; color: #b45309; }
        .footer { margin-top: 30px; padding-top: 16px; border-top: 2px solid #e5e7eb; font-size: 12px; color: #6b7280; text-align: center; }
        .note { margin-top: 12px; background: #ecfdf5; border-left: 4px solid #10b981; padding: 12px 14px; border-radius: 4px; font-size: 12px; color: #065f46; }
    </style>
</head>
<body>
    @php
        ...
        $jumlahNonUkmLabel = $jumlahNonUkm > 0 ? ($jumlahNonUkm . ' orang') : 'UKM semua';
