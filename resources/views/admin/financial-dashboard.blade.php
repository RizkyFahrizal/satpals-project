        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm" style="table-layout: fixed;">
                <thead class="border-b-2 border-yellow-200 bg-yellow-50">
                    <tr>
                        <th class="text-left py-3 px-4 font-bold text-gray-800" style="width: 80px;">Tipe</th>
                        <th class="text-left py-3 px-4 font-bold text-gray-800" style="width: 120px;">Judul</th>
                        <th class="text-left py-3 px-4 font-bold text-gray-800" style="width: 200px;">Keterangan</th>
                ...
                <tbody>
                    @forelse($allTransactions as $transaction)
                        <tr class="border-b border-gray-100 {{ $transaction['type'] === 'income' ? 'bg-green-50 hover:bg-green-100' : 'bg-red-50 hover:bg-red-100' }} transition-colors">
                            <td class="py-3 px-4" style="width: 80px;">
                            ...
                            <td class="py-3 px-4 font-semibold {{ $transaction['type'] === 'income' ? 'text-green-800' : 'text-red-800' }} truncate" style="width: 80px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                                {{ $transaction['title'] }}
                            </td>
                            <td class="py-3 px-4 text-gray-600" style="width: 240px;">
                                @if($transaction['type'] === 'income')
                            ...
                            <td class="py-3 px-4 text-gray-600 text-xs truncate" style="width: 100px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">{{ $transaction['creator']->name }}</td>
