...
@section('title', 'Tambah Prestasi - Admin Satya Palapa')

@section('header', 'Tambah Prestasi Baru')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="judul_lomba" id="judul_lomba" 
                        value="{{ old('judul_lomba') }}" required
                        ...
                        placeholder="Contoh: Festival Band Mahasiswa Nasional 2025">
                    @error('judul_lomba')
                ...
                <div>
                    ...
                    <select name="juara" id="juara" required
                        ...
                        <option value="{{ $value }}" {{ old('juara') === $value ? 'selected' : '' }}>🏆 {{ $label }}</option>
                        @endforeach
                    </select>
                    @error('juara')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="anggota" id="anggota" 
                        ...
                        placeholder="Pisahkan dengan koma, contoh: Andi (Vocal), Budi (Guitar), Citra (Bass)">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_lomba" id="tanggal_lomba" 
                        value="{{ old('tanggal_lomba') }}" required
                ...
                <div>
                    ...
                    <input type="text" name="tempat_lomba" id="tempat_lomba" 
                        value="{{ old('tempat_lomba') }}" required
                        ...
                        placeholder="Contoh: Gedung Serbaguna UPN Veteran Jawa Timur">
                    @error('tempat_lomba')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="penyelenggara" id="penyelenggara" 
                        ...
                        placeholder="Contoh: BEM Fakultas Teknik UPNVJT">
                    @error('penyelenggara')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="deskripsi" id="deskripsi" rows="4"
                        class="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400/20 transition-all @error('deskripsi') border-red-500 @enderror"
                        placeholder="Ceritakan tentang lomba ini, perjalanan hingga meraih prestasi...">{{ old('deskripsi') }}</textarea>
                    @error('deskripsi')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                        ...
                        <div class="relative">
                            <label for="{{ $field }}" class="block cursor-pointer">
                                <div class="border-2 border-dashed border-gray-300 rounded-xl p-4 text-center hover:border-yellow-400 transition-colors bg-gray-50 hover:bg-yellow-50">
                                    <div class="preview-{{ $field }} hidden">
                                        <img src="" alt="Preview" class="w-full h-32 object-cover rounded-lg mb-2">
                                    </div>
