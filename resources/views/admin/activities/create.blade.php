    ...
    <form action="{{ route('admin.activities.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="judul_kegiatan" value="{{ old('judul_kegiatan') }}" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('judul_kegiatan') border-red-500 @enderror"
                        placeholder="Contoh: Workshop Gitar Akustik 2026" required>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="tujuan_kegiatan" rows="2" 
                        ...
                        placeholder="Tujuan dari kegiatan ini...">{{ old('tujuan_kegiatan') }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="deskripsi" rows="4" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Deskripsi lengkap kegiatan...">{{ old('deskripsi') }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="date" name="tanggal_kegiatan" value="{{ old('tanggal_kegiatan') }}" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('tanggal_kegiatan') border-red-500 @enderror" required>
                ...
                <div class="md:col-span-3">
                    ...
                    <input type="text" name="tempat_kegiatan" value="{{ old('tempat_kegiatan') }}" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Contoh: Sekretariat UKM Satya Palapa">
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="ketua_pelaksana" value="{{ old('ketua_pelaksana') }}" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <div id="divisiContainer" class="space-y-3">
                        <div class="divisi-row flex gap-3 items-start">
                            <div class="flex-1">
                                <input type="text" name="divisi[0][nama_divisi]" 
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                    placeholder="Nama Divisi (cth: Acara, Perkap, Humas)">
                            </div>
                            <div class="flex-1">
                                <input type="text" name="divisi[0][ketua_divisi]" 
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="file" name="foto_{{ $i }}" id="foto_{{ $i }}" accept="image/*" class="hidden" onchange="previewImage(this, 'preview_{{ $i }}')">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <label class="flex items-center gap-3 cursor-pointer">
                ...
                <div>
                    <span class="font-medium text-gray-800">Publikasikan Langsung</span>
                    <p class="text-sm text-gray-500">Kegiatan akan langsung tampil di halaman publik</p>
                </div>
            </label>
        </div>
