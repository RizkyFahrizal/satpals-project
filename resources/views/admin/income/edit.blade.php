...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg border border-gray-100 shadow-sm p-6">
        <form action="{{ route('admin.income.update', $income) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <input type="text" name="title" class="input input-bordered w-full" 
                       placeholder="Contoh: Persewaan Alat, Turunan Kampus, atau Pendaftaran Expo"
            ...
            <div class="mb-6">
                ...
                <input type="date" name="income_date" class="input input-bordered w-full" 
                       value="{{ old('income_date', $income->income_date ? $income->income_date->format('Y-m-d') : date('Y-m-d')) }}" required>
                @error('income_date')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                <label class="block text-sm font-semibold text-gray-700 mb-3">Dokumen yang Sudah Diunggah</label>
                <div class="space-y-2">
            ...
            <div class="mb-6">
                <label class="block text-sm font-semibold text-gray-700 mb-2">Tambah Bukti & Dokumen Pendukung (Opsional)</label>
